...
**Find, rank, install, and safety-check Codex / Claude Agent Skills from GitHub.**<br>
...
[快速开始](#-快速开始) · [Demo](#-demo-find-and-review-a-pptx-skill) · [评分模型](#-scoring-model) · [安全扫描](#-safety-scan-examples) · [Codex / Claude](#-codex--claude-code)
...
它不替代内置 artifact tools。它先判断内置能力或已安装 skill 是否够用，只在专业化收益明显、任务重复、用户要求 latest / best，或本地能力不足时才搜索外部 skill。
